...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="forum.php" class="nav-link">Coffee Lover Forum</a></li>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('picture/header.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Welcome</a></a></span> <span>To Website Kopi Oncak</span></p>
            <h1 class="mb-0 bread">"Jagonya Kopi"</h1>
          </div>
        </div>
      </div>
    </div>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Jl. Nangka, Perum Cimanggis Permai Komplek TNI AD 201, Jl. Cenderawasih 4 Blok B1 N0.15 RT.005/RW.014, Suka Maju Baru, Tapos, Depok Jawa Barat </span>
					    </div>
		    			<div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-whatsapp"></span></div>
						    <span class="text">0878 8183 6341 (Filda Angellia, SKOM.,MMSI)</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-facebook"></span></div>
						    <span class="text">kopioncakofficial</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">kopioncakofficial@gmail.com</span>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <br><br>
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
						<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(picture/bg1.jpg);">
							<div class="text text-center">
								<h2>Our Menu Pricing</h2>
								<h5><font color="white" face="Comic Sans MS">Berikut Kami Sajikan<br> Kopi Oncak Berbagai Varian Harga Sesuai dengan Netto pada Kemasan</font></h5>
							</div>
						</div>
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(picture/kopi8.jpeg);">     
            </div>
        </div>
		  </div>
		</section>
          ...
          <?php $ambildata=$koneksi->query("SELECT * FROM produk ORDER BY id_produk DESC"); ?>
            <?php while($pecah = $ambildata->fetch_assoc()){ ?>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="foto_produk/<?php echo $pecah['foto_produk'] ?>" alt="Colorlib Template"></a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><b><?php echo $pecah['nama_produk'] ?></b></h3>
    						<p><?php echo $pecah['deskripsi_produk'] ?></p>
    						<font face="Arial Rounded MT Bold" color="black"><p><b>Price : Rp.<?php echo $pecah['harga_produk'] ?>,-</b></p></font>
    						<a href="https://api.whatsapp.com/send?phone=<?php echo $pecah['nomor_whatsapp'] ?>&text=<?php echo $pecah['pesan'] ?>" class="btn btn-warning"><b>Buy Now</b></a>
    					</div>
    				</div>
    			</div>
        <?php } ?>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div>
                    <img src="picture/kopi46.jpeg">
                  </div>
                  <div class="text text-center"><br><br>
                    <p class="mb-5 pl-4 line"><i class="icon-quote-left"></i> Seperti kopi, kuaduk sesukaku, kuteguk semauku, hingga kutemukan rasa pahit indah bersamamu <i class="icon-quote-right"></i></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div>
                    <img src="picture/kopi48.jpeg">
                  </div>
                  <div class="text text-center"><br><br>
                    <p class="mb-5 pl-4 line"><i class="icon-quote-left"></i> Kopi yang enak akan selalu menemukan penikmatnya <i class="icon-quote-right"></i></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div>
                    <img src="picture/kopi53.jpeg">
                  </div>
                  <div class="text text-center"><br><br>
                    <p class="mb-5 pl-4 line"><i class="icon-quote-left"></i> Aku menunggu kita ada di satu meja, ditemani kopi dengan aroma yang berbeda, membicarakan mimpi, bercengkerama tentang rencana <i class="icon-quote-right"></i></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div>
                    <img src="picture/kopi44.jpeg">
                  </div>
                  <div class="text text-center"><br><br>
                    <p class="mb-5 pl-4 line"><i class="icon-quote-left"></i> Sama seperti kopi, sajak yang indah juga memiliki penikmatnya tersendiri <i class="icon-quote-right"></i></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div>
                    <img src="picture/logokopioncak1.jpeg">
                  </div>
                  <div class="text text-center"><br><br>
                    <p class="mb-5 pl-4 line"><i class="icon-quote-left"></i> Jagonya Kopi <i class="icon-quote-right"></i></p>
                  </div>
                </div>
              </div>
            </div>
    	...
    	<div class="container">
    		<div class="row">
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="picture/kopi32.jpeg" class="img-fluid" alt="Colorlib Template"></a>
                </div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="picture/kopi17.jpeg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="picture/kopi2.jpeg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="picture/kopi14.jpeg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="picture/kopi5.jpeg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    		</div>
    	</div>
    </section>
